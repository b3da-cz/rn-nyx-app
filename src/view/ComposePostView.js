  ...
  render() {
    ...
    return (
      <View style={[Styling.groups.themeView(this.isDarkMode), { width: '100%', height: '100%' }]}>
        <Text style={[Styling.groups.themeComponent(this.isDarkMode), { width: '100%', fontSize: 24, lineHeight: 60 }]}>
        ...
        <TouchableOpacity
          style={[Styling.groups.themeComponent(this.isDarkMode), { width: '100%', fontSize: 24, lineHeight: 60 }]}
          accessibilityRole="button"
