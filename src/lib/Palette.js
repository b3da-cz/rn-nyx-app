...
export const createPalette = (
  ...
  background: IBMColorPalette[`${primaryColor}${isDarkTheme ? '100' : '10'}`],
  border: IBMColorPalette[`coolGray${isDarkTheme ? '80' : '30'}`],
  card: IBMColorPalette[`coolGray${isDarkTheme ? '90' : '20'}`],
  disabled: withAlpha(IBMColorPalette[`coolGray${isDarkTheme ? '10' : '90'}`], 0.35),
  error: IBMColorPalette[`red${isDarkTheme ? '70' : '60'}`],
  notification: IBMColorPalette[`${primaryColor}${isDarkTheme ? '80' : '70'}`],
  onBackground: IBMColorPalette[`${primaryColor}${isDarkTheme ? '10' : '100'}`],
  onSurface: IBMColorPalette[`${primaryColor}${isDarkTheme ? '10' : '100'}`],
  placeholder: withAlpha(IBMColorPalette[`${primaryColor}${isDarkTheme ? '10' : '100'}`], 0.6),
  primary: IBMColorPalette[`${primaryColor}${isDarkTheme ? '70' : '60'}`],
  secondary: IBMColorPalette[`${secondaryColor}${isDarkTheme ? '70' : '60'}`],
  tertiary: IBMColorPalette[`${tertiaryColor}${isDarkTheme ? '70' : '60'}`],
  surface: IBMColorPalette[`${primaryColor}${isDarkTheme ? '100' : '10'}`],
  text: IBMColorPalette[`${primaryColor}${isDarkTheme ? '10' : '100'}`],
})

// export const createPalette = ( // todo more neutral?
//   isDarkTheme: boolean,
//   primaryColor: string,
//   secondaryColor: string,
//   tertiaryColor: string,
...
//   accent: IBMColorPalette[`${primaryColor}${isDarkTheme ? '50' : '70'}`],
//   backdrop: withAlpha(IBMColorPalette.coolGray100, 0.5),
//   background: IBMColorPalette[`coolGray${isDarkTheme ? '100' : '10'}`],
//   border: IBMColorPalette[`coolGray${isDarkTheme ? '80' : '30'}`],
//   card: IBMColorPalette[`coolGray${isDarkTheme ? '90' : '20'}`],
//   disabled: withAlpha(IBMColorPalette[`coolGray${isDarkTheme ? '10' : '90'}`], 0.35),
//   error: IBMColorPalette[`red${isDarkTheme ? '70' : '60'}`],
//   notification: IBMColorPalette[`${primaryColor}${isDarkTheme ? '80' : '70'}`],
//   onBackground: IBMColorPalette[`coolGray${isDarkTheme ? '10' : '100'}`],
...
//   secondary: IBMColorPalette[`${secondaryColor}${isDarkTheme ? '70' : '60'}`],
//   tertiary: IBMColorPalette[`${tertiaryColor}${isDarkTheme ? '70' : '60'}`],
//   surface: IBMColorPalette[`coolGray${isDarkTheme ? '100' : '10'}`],
//   text: IBMColorPalette[`coolGray${isDarkTheme ? '10' : '100'}`],
// })
